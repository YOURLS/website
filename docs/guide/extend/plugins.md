...
Normal plugins are written (and hopefully maintained) by various YOURLS users. You will find the list in the dedicated repository: [github.com/YOURLS/awesome](https://github.com/YOURLS/awesome)
...
## Get your plugin listed on YOURLS/awesome
...
3. Open a pull request on [github.com/YOURLS/awesome](https://github.com/YOURLS/awesome).
